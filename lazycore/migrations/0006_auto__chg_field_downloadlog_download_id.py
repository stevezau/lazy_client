...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('download_log', 'download_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazycore.DownloadItem']))

    def backwards(self, orm):

        # Changing field 'DownloadLog.download_id'
        db.alter_column('download_log', 'download_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazycore.DownloadItem'], on_delete=models.DO_NOTHING))
    ...
    models = {
        ...
        u'lazycore.downloadlog': {
            ...
            'download_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lazycore.DownloadItem']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
