...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Imdbcache.posterimg'
        db.alter_column('imdbcache', 'posterimg', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Tvdbcache.posterimg'
        db.alter_column('tvdbcache', 'posterimg', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
