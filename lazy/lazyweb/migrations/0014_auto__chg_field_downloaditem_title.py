...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('download', 'title', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DownloadItem.title'
        raise RuntimeError("Cannot reverse this migration. 'DownloadItem.title' and its values cannot be restored.")
    ...
    models = {
        u'lazyweb.downloaditem': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'db_index': 'True'}),
