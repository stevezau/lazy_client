...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('imdbcache', 'posterimg', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Tvdbcache.posterimg'
        db.alter_column('tvdbcache', 'posterimg', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Imdbcache.posterimg'
        db.alter_column('imdbcache', 'posterimg', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Tvdbcache.posterimg'
        db.alter_column('tvdbcache', 'posterimg', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
