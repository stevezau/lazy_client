...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DownloadItem', fields ['ftppath']
        db.create_unique('download', ['ftppath'])


    def backwards(self, orm):
        # Removing unique constraint on 'DownloadItem', fields ['ftppath']
        db.delete_unique('download', ['ftppath'])
