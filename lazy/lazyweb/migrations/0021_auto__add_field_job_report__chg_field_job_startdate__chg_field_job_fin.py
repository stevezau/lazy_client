...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.report'
        db.add_column('jobs', 'report',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


        # Renaming column for 'Job.startdate' to match new field type.
        db.rename_column('jobs', 'startDate', 'startdate')
        # Changing field 'Job.startdate'
        db.alter_column('jobs', 'startdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Renaming column for 'Job.finishdate' to match new field type.
        db.rename_column('jobs', 'finishDate', 'finishdate')
        # Changing field 'Job.finishdate'
        db.alter_column('jobs', 'finishdate', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'DownloadItem.seasonoverride'
        db.add_column('download', 'seasonoverride',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DownloadItem.onlyget'
        db.add_column('download', 'onlyget',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.report'
        db.delete_column('jobs', 'report')


        # Renaming column for 'Job.startdate' to match new field type.
        db.rename_column('jobs', 'startdate', 'startDate')
        # Changing field 'Job.startdate'
        db.alter_column('jobs', 'startDate', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='startDate'))

        # Renaming column for 'Job.finishdate' to match new field type.
        db.rename_column('jobs', 'finishdate', 'finishDate')
        # Changing field 'Job.finishdate'
        db.alter_column('jobs', 'finishDate', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='finishDate'))
        # Deleting field 'DownloadItem.seasonoverride'
        db.delete_column('download', 'seasonoverride')

        # Deleting field 'DownloadItem.onlyget'
        db.delete_column('download', 'onlyget')
