...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tvshowmappings', (
            ...
            ('tvdbid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazyweb.Tvdbcache'], on_delete=models.DO_NOTHING)),
        ))
        db.send_create_signal(u'lazyweb', ['TVShowMappings'])
        ...
        db.create_table('download', (
            ...
            ('imdbid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazyweb.Imdbcache'], null=True, on_delete=models.DO_NOTHING, blank=True)),
