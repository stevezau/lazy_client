...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'download', 'path', 'ftppath')
        db.rename_column(u'download', 'lftppid', 'pid')
        db.rename_column(u'download', 'imdbID', 'imdbid')
        db.rename_column(u'imdbcache', 'posterImg', 'posterimg')
        db.rename_column(u'imdbcache', 'desc', 'description')
        db.rename_column(u'tvdbcache', 'posterImg', 'posterimg')
        db.rename_column(u'tvdbcache', 'network', 'networks')
        db.rename_column(u'tvdbcache', 'genre', 'genres')
        db.rename_column(u'tvdbcache', 'desc', 'description')

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'DownloadItem.path' and its values cannot be restored.")
