...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('download_log', 'download_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazyweb.DownloadItem']))

    def backwards(self, orm):

        # Changing field 'DownloadLog.download_id'
        db.alter_column('download_log', 'download_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazyweb.DownloadItem'], on_delete=models.DO_NOTHING))
    ...
    models = {
        ...
        u'lazyweb.downloadlog': {
            'Meta': {'object_name': 'DownloadLog', 'db_table': "'download_log'"},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'download_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lazyweb.DownloadItem']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
