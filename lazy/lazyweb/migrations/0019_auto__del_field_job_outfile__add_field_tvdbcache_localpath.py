...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.outfile'
        db.delete_column('jobs', 'outFile')

        # Adding field 'Tvdbcache.localpath'
        db.add_column('tvdbcache', 'localpath',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Job.outfile'
        db.add_column('jobs', 'outfile',
                      self.gf('django.db.models.fields.TextField')(null=True, db_column='outFile', blank=True),
                      keep_default=False)

        # Deleting field 'Tvdbcache.localpath'
        db.delete_column('tvdbcache', 'localpath')
