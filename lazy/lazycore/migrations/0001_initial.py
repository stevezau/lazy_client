...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tvshowmappings', (
            ...
            ('tvdbid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazycore.Tvdbcache'], on_delete=models.DO_NOTHING)),
        ))
        db.send_create_signal(u'lazycore', ['TVShowMappings'])
        ...
        db.create_table('download', (
            ...
            ('imdbid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazycore.Imdbcache'], null=True, on_delete=models.DO_NOTHING, blank=True)),
            ('tvdbid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazycore.Tvdbcache'], null=True, on_delete=models.DO_NOTHING, blank=True)),
            ...
            ('onlyget', self.gf('lazycore.utils.jsonfield.fields.JSONField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'lazycore', ['DownloadItem'])
        ...
        db.send_create_signal(u'lazycore', ['Imdbcache'])
        ...
        db.create_table('jobs', (
            ...
            ('report', self.gf('lazycore.utils.jsonfield.fields.JSONField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'lazycore', ['Job'])
        ...
        db.send_create_signal(u'lazycore', ['Tvdbcache'])
