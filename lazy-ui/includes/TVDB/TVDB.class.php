		...
		protected static function request($params) {
			...
			switch($params['action']) {
                ...
                case 'get_favs':
					...
					$url = self::apiUrl.'User_Favorites.php?accountid='.$accountid;
                ...
                case 'del_fav':
                	...
                	if ($id) {
                		$url = self::apiUrl.'User_Favorites.php?accountid='.$accountid.'&type=remove&seriesid='.$id;
                ...
                case 'add_fav':
                		...
                		if ($id) {
                			$url = self::apiUrl.'User_Favorites.php?accountid='.$accountid.'&type=add&seriesid='.$id;
