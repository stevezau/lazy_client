...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DownloadItem.epsiodes'
        db.add_column('download', 'epsiodes',
                      self.gf('lazy_client_core.utils.jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DownloadItem.seasons'
        db.add_column('download', 'seasons',
                      self.gf('lazy_client_core.utils.jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DownloadItem.epsiodes'
        db.delete_column('download', 'epsiodes')

        # Deleting field 'DownloadItem.seasons'
        db.delete_column('download', 'seasons')
