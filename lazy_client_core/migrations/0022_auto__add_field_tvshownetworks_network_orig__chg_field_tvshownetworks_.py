...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TVShowNetworks.network_orig'
        db.add_column('tvshow_networks', 'network_orig',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, db_index=True),
                      keep_default=False)


        # Changing field 'TVShowNetworks.network'
        db.alter_column('tvshow_networks', 'network', self.gf('lazy_client_core.utils.common.LowerCaseCharField')(unique=True, max_length=150))
        # Adding field 'GenreNames.genre_orig'
        db.add_column('genre_names', 'genre_orig',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, db_index=True),
                      keep_default=False)


        # Changing field 'GenreNames.genre'
        db.alter_column('genre_names', 'genre', self.gf('lazy_client_core.utils.common.LowerCaseCharField')(unique=True, max_length=150))

    def backwards(self, orm):
        # Deleting field 'TVShowNetworks.network_orig'
        db.delete_column('tvshow_networks', 'network_orig')


        # Changing field 'TVShowNetworks.network'
        db.alter_column('tvshow_networks', 'network', self.gf('django.db.models.fields.CharField')(max_length=150, unique=True))
        # Deleting field 'GenreNames.genre_orig'
        db.delete_column('genre_names', 'genre_orig')


        # Changing field 'GenreNames.genre'
        db.alter_column('genre_names', 'genre', self.gf('django.db.models.fields.CharField')(max_length=150, unique=True))
