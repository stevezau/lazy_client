...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('download_log', (
            ...
            ('download_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.DownloadItem'], on_delete=models.DO_NOTHING)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'lazy_client_core', ['DownloadLog'])
    ...
    models = {
        ...
        u'lazy_client_core.downloadlog': {
            ...
            'download_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lazy_client_core.DownloadItem']", 'on_delete': 'models.DO_NOTHING'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
