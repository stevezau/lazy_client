...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TVShow.ignored'
        db.add_column('tvdbcache', 'ignored',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TVShow.favorite'
        db.add_column('tvdbcache', 'favorite',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Movie.ignored'
        db.add_column('imdbcache', 'ignored',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TVShow.ignored'
        db.delete_column('tvdbcache', 'ignored')

        # Deleting field 'TVShow.favorite'
        db.delete_column('tvdbcache', 'favorite')

        # Deleting field 'Movie.ignored'
        db.delete_column('imdbcache', 'ignored')
