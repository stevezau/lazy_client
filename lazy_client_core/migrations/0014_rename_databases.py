...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('download', 'tvdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.tvshow'], null=True, on_delete=models.DO_NOTHING))

        # Changing field 'DownloadItem.imdbid'
        db.alter_column('download', 'imdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.movie'], null=True, on_delete=models.DO_NOTHING))

        # Changing field 'TVShowMappings.tvdbid'
        db.alter_column('tvshowmappings', 'tvdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.tvshow'], on_delete=models.DO_NOTHING))

    def backwards(self, orm):
        # Changing field 'DownloadItem.tvdbid'
        db.alter_column('download', 'tvdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.Tvdbcache'], null=True, on_delete=models.DO_NOTHING))

        # Changing field 'DownloadItem.imdbid'
        db.alter_column('download', 'imdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.Imdbcache'], null=True, on_delete=models.DO_NOTHING))

        # Changing field 'TVShowMappings.tvdbid'
        db.alter_column('tvshowmappings', 'tvdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.Tvdbcache'], on_delete=models.DO_NOTHING))
    ...
    models = {
        u'lazy_client_core.downloaditem': {
            ...
            'imdbid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lazy_client_core.Movie']", 'null': 'True', 'on_delete': 'models.DO_NOTHING', 'blank': 'True'}),
            ...
            'tvdbid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lazy_client_core.TVShow']", 'null': 'True', 'on_delete': 'models.DO_NOTHING', 'blank': 'True'}),
        ...
        u'lazy_client_core.tvshowmappings': {
            ...
            'tvdbid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lazy_client_core.TVShow']", 'on_delete': 'models.DO_NOTHING'})
        },
