...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('download', 'tvdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.TVShow'], null=True, on_delete=models.SET_NULL))

        # Changing field 'DownloadItem.imdbid'
        db.alter_column('download', 'imdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.Movie'], null=True, on_delete=models.SET_NULL))
