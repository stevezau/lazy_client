...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tvshow_networks', (
            ...
            ('network', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150, db_index=True)),
        ))
        ...
        db.create_table('genre_names', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('genre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150, db_index=True)),
        ))
        db.send_create_signal('lazy_client_core', ['GenreNames'])

        # Deleting field 'TVShow.networks'
        db.delete_column('tvdbcache', 'networks')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TVShow.networks'
        db.add_column('tvdbcache', 'networks',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TVShow.network'
        db.delete_column('tvdbcache', 'network_id')
    ...
    models = {
        ...
        'lazy_client_core.genrenames': {
            ...
            'genre': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '150', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'lazy_client_core.tvshownetworks': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'network': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '150', 'db_index': 'True'})
        },
