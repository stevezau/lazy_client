...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DownloadLog.download_id'
        db.alter_column('download_log', 'download_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.DownloadItem'], on_delete=models.DO_NOTHING))
