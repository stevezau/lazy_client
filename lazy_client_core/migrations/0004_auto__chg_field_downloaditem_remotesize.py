...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DownloadItem.remotesize'
        db.alter_column('download', 'remotesize', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'DownloadItem.remotesize'
        db.alter_column('download', 'remotesize', self.gf('django.db.models.fields.IntegerField')(null=True))
