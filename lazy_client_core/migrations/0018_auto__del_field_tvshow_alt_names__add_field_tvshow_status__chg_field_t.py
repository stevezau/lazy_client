...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TVShow.alt_names'
        db.delete_column('tvdbcache', 'alt_names')

        # Adding field 'TVShow.status'
        db.add_column('tvdbcache', 'status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'TVShowMappings.tvdbid'
        db.alter_column('tvshowmappings', 'tvdbid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.TVShow']))

    def backwards(self, orm):
        # Adding field 'TVShow.alt_names'
        db.add_column('tvdbcache', 'alt_names',
                      self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TVShow.status'
        db.delete_column('tvdbcache', 'status')
    ...
    models = {
        'lazy_client_core.downloaditem': {
            ...
            'tvdbid': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lazy_client_core.TVShow']", 'null': 'True', 'on_delete': 'models.DO_NOTHING', 'blank': 'True'}),
