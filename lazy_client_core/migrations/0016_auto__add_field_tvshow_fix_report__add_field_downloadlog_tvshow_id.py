...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('download_log', 'tvshow_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.TVShow'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TVShow.fix_report'
        db.delete_column('tvdbcache', 'fix_report')

        # Deleting field 'DownloadLog.tvshow_id'
        db.delete_column('download_log', 'tvshow_id_id')
    ...
    models = {
        ...
        'lazy_client_core.tvshowmappings': {
            ...
            'tvdbid': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lazy_client_core.TVShow']", 'on_delete': 'models.DO_NOTHING'})
        },
