...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seasons.path'
        db.add_column('seasons', 'path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Epsiodes.path'
        db.add_column('epsiodes', 'path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seasons.path'
        db.delete_column('seasons', 'path')

        # Deleting field 'Epsiodes.path'
        db.delete_column('epsiodes', 'path')
    ...
    models = {
        ...
        'lazy_client_core.epsiodes': {
            'Meta': {'ordering': "['epsiode']", 'object_name': 'Epsiodes', 'db_table': "'epsiodes'"},
        ...
        'lazy_client_core.seasons': {
            'Meta': {'ordering': "['season']", 'object_name': 'Seasons', 'db_table': "'seasons'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'path': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
