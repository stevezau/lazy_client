...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DownloadItem.video_files'
        db.add_column('download', 'video_files',
                      self.gf('lazy_client_core.utils.jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'DownloadItem.retries'
        db.alter_column('download', 'retries', self.gf('django.db.models.fields.IntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DownloadItem.video_files'
        db.delete_column('download', 'video_files')


        # Changing field 'DownloadItem.retries'
        db.alter_column('download', 'retries', self.gf('django.db.models.fields.IntegerField')(null=True))
