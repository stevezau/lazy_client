...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('lazy_client_core', ['Seasons'])

        # Adding model 'Epsiodes'
        db.create_table('epsiodes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('aired', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('overview', self.gf('django.db.models.fields.TextField')(max_length=255, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=150, db_index=True)),
            ('tvdbid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.TVShow'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.Seasons'])),
            ('epsiode', self.gf('django.db.models.fields.IntegerField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('lazy_client_core', ['Epsiodes'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Epsiodes'
        db.delete_table('epsiodes')
    ...
    models = {
        'lazy_client_core.downloaditem': {
            ...
            'epsiodes': ('lazy_client_core.utils.jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'quality': ('lazy_client_core.utils.jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'seasons': ('lazy_client_core.utils.jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'lazy_client_core.epsiodes': {
            'Meta': {'ordering': "['-id']", 'object_name': 'Epsiodes', 'db_table': "'epsiodes'"},
            'aired': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'epsiode': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'overview': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'season': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lazy_client_core.Seasons']"}),
        ...
        'lazy_client_core.seasons': {
            'Meta': {'ordering': "['-id']", 'object_name': 'Seasons', 'db_table': "'seasons'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
