...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DownloadLog.job_id'
        db.add_column('download_log', 'job_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.Job'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'DownloadLog.download_id'
        db.alter_column('download_log', 'download_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.DownloadItem'], null=True))

    def backwards(self, orm):
        # Deleting field 'DownloadLog.job_id'
        db.delete_column('download_log', 'job_id_id')


        # User chose to not deal with backwards NULL issues for 'DownloadLog.download_id'
        raise RuntimeError("Cannot reverse this migration. 'DownloadLog.download_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'DownloadLog.download_id'
        db.alter_column('download_log', 'download_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lazy_client_core.DownloadItem']))
